...
void board_button_init_polling(void)
{
    ...
    /* The Discovery board (and Renode's UserButton model) drives PA0. */
    gpio.Pull = GPIO_NOPULL;
    gpio.Speed = GPIO_SPEED_FREQ_LOW;
...
{
    /* TODO(02.1): Configure PA0 rising-edge EXTI; enable GPIOA, configure HAL GPIO, then NVIC priority 6 and EXTI0 IRQ. */
