...
Only unsigned decimal digits are accepted. To build for ADC1/PA1 hardware use
`python tools/build.py 05 --hardware --clean`; only help/status are then exposed.
Acquisition failures mark INVALID. Frozen simulated samples age toward STALE.
