...
If several releases are overdue, run the job once and count the skipped releases.
This prevents catch-up bursts; it does not recreate missed sensor samples.
